...
public class ShapesLISFactory implements ImageFactory {
    ...
    public Image makeImage() {
        ...
        list.add(new TriangleRectangle(TriangleRotation.SOUTH_RIGHT,60, 0, 140, 280, dark));
        list.add(new TriangleRectangle(TriangleRotation.SOUTH_RIGHT,60, 280, 280, 140, dark));
